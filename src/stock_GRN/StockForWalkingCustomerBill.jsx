...
const StockForWalkingCustomerBill = ({ onClose, onAddToBill }) => {
              ...
              <tr key={item._id}>
                ...
                <td className="px-3 py-2">
                  <button
                    ...
                    className="px-2 py-1 bg-green-600 text-white rounded hover:bg-green-700 cursor-pointer"
                  >
                    BILL
                  </button>
                </td>
  ...
  <div className="fixed inset-0 z-[60] flex items-center justify-center">
    <div className="bg-yellow-50 rounded-lg shadow-lg p-5 w-80 text-center">
      <p className="text-sm text-gray-800 mb-4 font-medium">
        Confirm billing and reduce stock?
      </p>
...
export default StockForWalkingCustomerBill;
