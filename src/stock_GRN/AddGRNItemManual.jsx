  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-xl w-[600px] p-4 text-xs">
        ...
        {category === "accessory" && (
            <>
                <Input label="Description*" value={fields.description} onChange={v => updateField("description", v)} />
                <Input label="Brand" value={fields.brand} onChange={v => updateField("brand", v)} />
                <Input label="Color" value={fields.color} onChange={v => updateField("color", v)} />
        ...
        {category === "spare" && (
            <>
                <Input label="Description*" value={fields.description} onChange={v => updateField("description", v)} />
                <Input label="Compatibility*" value={fields.compatibility} onChange={v => updateField("compatibility", v)} />
                <Input label="Condition*" value={fields.condition} onChange={v => updateField("condition", v)} />
                <Input label="Other Value" value={fields.otherValue} onChange={v => updateField("otherValue", v)} />
            </>
            )}
       ...
       {category === "product" && (
            <>
                <Input label="Model*" value={fields.model} onChange={v => updateField("model", v)} />
                <Input label="Color" value={fields.color} onChange={v => updateField("color", v)} />
                <Input label="Region" value={fields.region} onChange={v => updateField("region", v)} />
                <Input label="Serial Number*" value={fields.serialNumber} onChange={v => updateField("serialNumber", v)} />
                <Input label="IMEI Number" value={fields.imeiNumber} onChange={v => updateField("imeiNumber", v)} />
                <Input label="Condition" value={fields.condition} onChange={v => updateField("condition", v)} />
                <Input label="Other Value or Capacity" value={fields.otherValue} onChange={v => updateField("otherValue", v)} />
            </>
            )}
